...
export function AgreementCheckbox({
  ...
  return (
    <div className="flex items-center xl:items-start gap-3 select-none max-w-150">
      ...
      <motion.div
        ...
        className={`relative w-8 h-8 min-w-8 rounded-sm border-2 flex items-center justify-center cursor-pointer transition-colors duration-200
          ...
          ${showAgreementError ? 'border-[#EF4444] ring-2 ring-[#EF4444]/30' : ''}
        `}
        animate={showAgreementError ? {
          scale: [1, 1.05, 1],
        } : {}}
